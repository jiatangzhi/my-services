...
class CreditRiskInput(BaseModel):
    ...
    class Config:
        allow_population_by_field_name = True  # Enables 'Saving accounts' instead of 'Saving_accounts'
        schema_extra = {
            "example": {
                "Age": 35,
                "Sex": "male",
...
class CreditRiskOutput(BaseModel):
    ...
    """
    prediction: str = Field(..., description="Risk prediction ('good' o 'bad').")
    probability: float = Field(..., ge=0, le=1, description="Risk Probability to be 'good'.")
